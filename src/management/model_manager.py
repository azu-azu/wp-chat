...
class ModelManager:
    ...
    def _load_model_config(self) -> dict[str, Any]:
        ...
        return {
            ...
            "models": {
                "cpu": get_config_value(
                    "reranker.models.cpu", "cross-encoder/ms-marco-MiniLM-L-6-v2"
                ),
                "gpu": get_config_value(
                    "reranker.models.gpu", "cross-encoder/ms-marco-MiniLM-L-12-v2"
                ),
                "fallback": get_config_value(
                    "reranker.models.fallback", "cross-encoder/ms-marco-MiniLM-L-6-v2"
                ),
            },
